...
(function() {
  var $, Backbone, Color, DirectionPainter, GameView, Image, MetaPainter, OrientationPainter, RaphaelPainter, Sprite, View, _, coordsDecorator, decorate, decorators, helpers, v, validator,
    slice = [].slice;
  ...
  GameView = exports.GameView = View.GameView.extend4000({
    initialize: function() {
      var calculateSizes, ctx, el, paper;
      el = this.get('el');
      ...
      calculateSizes = (function(_this) {
        return function() {
          ...
          elHeight = $(_this.paper).height();
          elWidth = $(_this.paper).width();
      ...
      return this.on('definePainter', (function(_this) {
        return function(painter) {
          var _findForwardMarker, zindex;
          if (painter.prototype.zindex == null) {
            return;
          }
          zindex = painter.prototype.zindex;
          return _findForwardMarker = function(marker) {
            var sorted;
