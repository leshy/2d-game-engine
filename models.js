...
(function() {
  var Backbone, Clock, ClockListener, Direction, Field, Game, Point, State, StatesFromTags, Tagged, decorators, helpers, _,
    __slice = [].slice,
  ...
  ClockListener = exports.ClockListener = Backbone.Model.extend4000({
    "in": function(n, callback) {
      if (!(this.clockParent.tick + n)) {
        console.log("I HAVE NOT PARENTA!", n, this.name);
      }
