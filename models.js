...
(function() {
  var Backbone, Direction, Field, Game, Mover, Point, State, StatesFromTags, Tagged, decorators, helpers, mover, _,
    __slice = [].slice,
  ...
  exports.Game = Game = Field.extend4000({
    initialize: function() {
      this.movers = new Backbone.Collection();
      this.controls = {};
      this.state = {};
      this.tickspeed = 50;
      this.tick = 0;
    ...
    defineMover: function() {
      ...
      name = arguments[0], definitions = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
